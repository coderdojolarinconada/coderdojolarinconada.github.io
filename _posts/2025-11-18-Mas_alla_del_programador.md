---
layout: post
title: Más allá del programador. Profesiones que dominan el código
categories: Programacion
author: CoderDojo La Rinconada
anyo: "2025"
---

Hola a todos, en este post vamos a hablar como indica el título "Más alla del programador: profesiones que dominan el código "

En cierto momento, alguien plantea: ¿por qué debería aprender a programar si mi futuro está en el deporte, la biología o la medicina?

Un gran número de profesionales ajenos al ámbito tecnológico se han dado cuenta de que aprender a programar les da la capacidad de automatizar tareas, analizar datos de forma más eficaz y resolver problemas particulares de su área sin tener que depender de un departamento de informática.

Daremos un breve recorrido, sin nombrar a todas (sería interminable), por las diversas profesiones que pueden necesitar la programación para desempeñar su trabajo de manera más efectiva.
...
- Fisioterapeutas y científicos del deporte examinan el movimiento para evitar lesiones, utilizando imágenes de cámaras y sensores corporales.

- Observadores de carreras de Fórmula 1 que analizan las diferentes variables que influyen en el desgaste de los neumáticos, consumo de combustible y las paradas en boxes.

- Otros aspectos del deporte, como el arbitraje, también se benefician de los medios tecnologicos existentes hoy en día.
...
[laboratorio]: /images/laboratorio.jpg
[aplicacion]: /images/aplicacion.jpg
[sensores]: /images/sensores.webp